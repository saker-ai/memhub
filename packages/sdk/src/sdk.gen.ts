 ...
 */
export const getTeams = <ThrowOnError extends boolean = false>(options?: Options<GetTeamsData, ThrowOnError>) => (options?.client ?? client).get<GetTeamsResponses, unknown, ThrowOnError>({ url: '/teams', ...options });
 ...
 * Archive a team
 */
export const deleteTeamsByTeamId = <ThrowOnError extends boolean = false>(options: Options<DeleteTeamsByTeamIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteTeamsByTeamIdResponses, unknown, ThrowOnError>({ url: '/teams/{team_id}', ...options });

/**
 * Get a team
 */
export const getTeamsByTeamId = <ThrowOnError extends boolean = false>(options: Options<GetTeamsByTeamIdData, ThrowOnError>) => (options.client ?? client).get<GetTeamsByTeamIdResponses, GetTeamsByTeamIdErrors, ThrowOnError>({ url: '/teams/{team_id}', ...options });

/**
 * Update a team
 */
export const putTeamsByTeamId = <ThrowOnError extends boolean = false>(options: Options<PutTeamsByTeamIdData, ThrowOnError>) => (options.client ?? client).put<PutTeamsByTeamIdResponses, unknown, ThrowOnError>({
    url: '/teams/{team_id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * List team issues
 */
export const getTeamsByTeamIdIssues = <ThrowOnError extends boolean = false>(options: Options<GetTeamsByTeamIdIssuesData, ThrowOnError>) => (options.client ?? client).get<GetTeamsByTeamIdIssuesResponses, unknown, ThrowOnError>({ url: '/teams/{team_id}/issues', ...options });

/**
 * Create an issue
 */
export const postTeamsByTeamIdIssues = <ThrowOnError extends boolean = false>(options: Options<PostTeamsByTeamIdIssuesData, ThrowOnError>) => (options.client ?? client).post<PostTeamsByTeamIdIssuesResponses, unknown, ThrowOnError>({
 ...
 * Delete an issue
 */
export const deleteTeamsByTeamIdIssuesByIssueId = <ThrowOnError extends boolean = false>(options: Options<DeleteTeamsByTeamIdIssuesByIssueIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteTeamsByTeamIdIssuesByIssueIdResponses, unknown, ThrowOnError>({ url: '/teams/{team_id}/issues/{issue_id}', ...options });

/**
 * Get an issue
 */
export const getTeamsByTeamIdIssuesByIssueId = <ThrowOnError extends boolean = false>(options: Options<GetTeamsByTeamIdIssuesByIssueIdData, ThrowOnError>) => (options.client ?? client).get<GetTeamsByTeamIdIssuesByIssueIdResponses, unknown, ThrowOnError>({ url: '/teams/{team_id}/issues/{issue_id}', ...options });

/**
 * Update an issue
 */
export const putTeamsByTeamIdIssuesByIssueId = <ThrowOnError extends boolean = false>(options: Options<PutTeamsByTeamIdIssuesByIssueIdData, ThrowOnError>) => (options.client ?? client).put<PutTeamsByTeamIdIssuesByIssueIdResponses, unknown, ThrowOnError>({
 ...
 * Assign an issue
 */
export const postTeamsByTeamIdIssuesByIssueIdAssign = <ThrowOnError extends boolean = false>(options: Options<PostTeamsByTeamIdIssuesByIssueIdAssignData, ThrowOnError>) => (options.client ?? client).post<PostTeamsByTeamIdIssuesByIssueIdAssignResponses, unknown, ThrowOnError>({
 ...
 */
export const getTeamsByTeamIdIssuesByIssueIdComments = <ThrowOnError extends boolean = false>(options: Options<GetTeamsByTeamIdIssuesByIssueIdCommentsData, ThrowOnError>) => (options.client ?? client).get<GetTeamsByTeamIdIssuesByIssueIdCommentsResponses, unknown, ThrowOnError>({ url: '/teams/{team_id}/issues/{issue_id}/comments', ...options });

/**
 * Post a comment on an issue
 */
export const postTeamsByTeamIdIssuesByIssueIdComments = <ThrowOnError extends boolean = false>(options: Options<PostTeamsByTeamIdIssuesByIssueIdCommentsData, ThrowOnError>) => (options.client ?? client).post<PostTeamsByTeamIdIssuesByIssueIdCommentsResponses, unknown, ThrowOnError>({
 ...
 */
export const getTeamsByTeamIdIssuesByIssueIdHandoffs = <ThrowOnError extends boolean = false>(options: Options<GetTeamsByTeamIdIssuesByIssueIdHandoffsData, ThrowOnError>) => (options.client ?? client).get<GetTeamsByTeamIdIssuesByIssueIdHandoffsResponses, unknown, ThrowOnError>({ url: '/teams/{team_id}/issues/{issue_id}/handoffs', ...options });

/**
 * List team members
 */
export const getTeamsByTeamIdMembers = <ThrowOnError extends boolean = false>(options: Options<GetTeamsByTeamIdMembersData, ThrowOnError>) => (options.client ?? client).get<GetTeamsByTeamIdMembersResponses, unknown, ThrowOnError>({ url: '/teams/{team_id}/members', ...options });

/**
 * Add a team member
 */
export const postTeamsByTeamIdMembers = <ThrowOnError extends boolean = false>(options: Options<PostTeamsByTeamIdMembersData, ThrowOnError>) => (options.client ?? client).post<PostTeamsByTeamIdMembersResponses, unknown, ThrowOnError>({
 ...
 */
export const deleteTeamsByTeamIdMembersByMemberId = <ThrowOnError extends boolean = false>(options: Options<DeleteTeamsByTeamIdMembersByMemberIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteTeamsByTeamIdMembersByMemberIdResponses, unknown, ThrowOnError>({ url: '/teams/{team_id}/members/{member_id}', ...options });

/**
 * Update a member
 */
export const putTeamsByTeamIdMembersByMemberId = <ThrowOnError extends boolean = false>(options: Options<PutTeamsByTeamIdMembersByMemberIdData, ThrowOnError>) => (options.client ?? client).put<PutTeamsByTeamIdMembersByMemberIdResponses, unknown, ThrowOnError>({
